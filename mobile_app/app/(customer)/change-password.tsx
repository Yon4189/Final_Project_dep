...
export default function ChangePassword() {
  ...
  const validateForm = () => {
    ...
    if (!formData.new_password) {
      ...
      newErrors.new_password = t('profile.charCount', 'Password must be at least 8 characters');
    ...
    if (!formData.confirm_password) {
      newErrors.confirm_password = t('auth.reenterPassword', 'Please confirm your password');
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        Alert.alert(t('common.error', 'Error'), response.message || t('profile.changePasswordError', 'Failed to change password'));
      }
    } catch (error: any) {
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.passwordContainer}>
              <AppInput
                ...
                placeholder={t('auth.enterPassword', 'Enter your current password')}
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.passwordContainer}>
              <AppInput
                ...
                placeholder={t('auth.newPassword', 'Enter new password')}
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.passwordContainer}>
              <AppInput
                ...
                placeholder={t('auth.reenterPasswordPlaceholder', 'Re-enter new password')}
