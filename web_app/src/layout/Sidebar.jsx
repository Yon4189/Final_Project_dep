      ...
      <nav className="flex-1 mt-4">
        ...
        <div className="mt-4 px-3">
          <button
            ...
            className={`group w-full flex items-center rounded-2xl transition-all duration-300 ${!isMini ? 'justify-between px-6 py-4' : 'justify-center py-4'} ${isServicesActive ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-xl shadow-blue-900/40' : 'hover:bg-white/5 hover:text-white'
              }`}
          ...
          >
            ...
            {!isMini && (
              <div className={`transition-transform duration-300 ${isServicesOpen ? 'rotate-180' : ''}`}>
                <ChevronDown size={18} className={isServicesActive ? 'text-white' : 'text-slate-600'} />
              </div>
            )}
          </button>
          ...
          >
            ...
            {!isMini && (
              <div className={`transition-transform duration-300 ${isVerificationOpen ? 'rotate-180' : ''}`}>
                <ChevronDown size={18} className={isVerificationActive ? 'text-white' : 'text-slate-600'} />
              </div>
            )}
          </button>
          ...
          >
            ...
            {!isMini && (
              <div className={`transition-transform duration-300 ${isUsersOpen ? 'rotate-180' : ''}`}>
                <ChevronDown size={18} className={isUsersActive ? 'text-white' : 'text-slate-600'} />
              </div>
            )}
          </button>
          ...
          >
            ...
            {!isMini && (
              <div className={`transition-transform duration-300 ${isBookingsOpen ? 'rotate-180' : ''}`}>
                <ChevronDown size={18} className={isBookingsActive ? 'text-white' : 'text-slate-600'} />
              </div>
            )}
          </button>
          ...
          {otherMenuItems.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.path}
                onClick={() => isMobile && onClose()}
                className={`group flex items-center rounded-2xl transition-all duration-300 ${!isMini ? 'gap-4 px-6 py-3' : 'justify-center py-4'} ${isActive ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-xl shadow-blue-900/40' : 'hover:bg-white/5 hover:text-white'
                  }`}
